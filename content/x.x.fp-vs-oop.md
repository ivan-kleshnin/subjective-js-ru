...
Роль интерфейсов в JS выполняет Утиная Типизация. Поэтому, неожиданным, но работающим решением
Ф-части проблемы Выразительности оказывется разделение кода на слои, где внешний слой
является функциональным, а внутренний – объектно-ориентированным. Разница между типами, при этом,
...
Такой подход относится к категории архитектурных (т.е. близких, по своей сути, к конвенциям / парадигмам).
